 ...
 * @constructor
 *
 * @param {Cartesian3|Quaternion|Number} value The constant value that the spline evaluates to.
 *
 * @example
 ...
 * @returns {Cartesian3|Quaternion|Number} The modified result parameter or the value that the constant spline represents.
 */
ConstantSpline.prototype.evaluate = function (time, result) {
  ...
  result = defaultValue(result, new ValueType());
  result = ValueType.clone(this._value, result);
